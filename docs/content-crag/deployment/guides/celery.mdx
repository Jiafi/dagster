...
Let's construct a very parallel toy graph and then create a job that uses the Celery executor.
...
Now you can execute the parallel job from Dagit with the following config:
